export const APP_ENV = {
  ...
  MAINNET_TOKEN: process.env.NEXT_PUBLIC_ZK_ADDRESS_MAINNET as `0x${string}`,
  SEPOLIA_TOKEN: process.env.NEXT_PUBLIC_ZK_ADDRESS_SEPOLIA as `0x${string}`,
  ZK_DECIMAL: process.env.NEXT_PUBLIC_ZK_DECIMAL as number | undefined || 18,
