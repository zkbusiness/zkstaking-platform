...
const StakeLayout: NextPage = () => {
    ...
    return (
        <>
            <section
                className="my-16 max-w-[620px] justify-self-center w-full"
                id="stake"
            >
                <div className="w-full">
                    ...
                    <br />
                    <div className="bg-background rounded-lg md:rounded-[40px] p-4 md:p-10">
                        <div className="flex flex-col justify-start items-start gap-4">
                            <div className="text-lg flex gap-2 justify-center items-center">
                                <div className="">Total Staked :</div>
                                <div className="text-[#4075FF]">150000</div>
                            </div>
                            <div className="text-lg flex gap-2 justify-center items-center">
                                <div className="">Total User :</div>
                                <div className="text-[#4075FF]">5000</div>
                            </div>
                        </div>
                        ...
                        <div className="">
                            ...
                            <div className="flex justify-between items-center gap1 mt-8 mb-4">
                                ...
                                <div className=" font-thin">
                                    {isConnected ? (
                                        <>My ZK {numeral(balance).format("0,0")}</>
                                    ) : (
                                        <></>
                                    )}
                                </div>
                                        ...
                                        <div className=" bg-background flex flex-col  sm:flex-row items-center justify-between rounded-md px-4 py-3 gap-4 ">
                                            <div className="flex  relative h-full w-full">
                                                <Image
                                                    width={50}
                                                    height={50}
                                                    className="relative h-[50px] w-[50px] top-0 left-0 z-10 m-2 rounded-md"
                                                    src="/images/zk-black.jpg"
                                                    alt="code-token"
                                                />
                                                <input
                                                    // disabled
