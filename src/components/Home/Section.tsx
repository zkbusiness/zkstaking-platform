...
export const Section: React.FC<SectionProps> = ({
    ...
    return (
        <section
            className={` px-6 lg:px-12 xl:px-28 py-8 md:py-10 ${reversed ? "" : "md:flex-row-reverse"
        ...
        >
            ...
            <div
                className={`space-y-4 md:space-y-6 ${imageSrc ? "md:max-w-[50%]" : ""
                    } `}
            >
                ...
                <h2
                    className={`text-5xl font-bold ${imageSrc ? "max-w-[500px]" : ""
                        } text-white`}
                >
                    {title}
                </h2>
